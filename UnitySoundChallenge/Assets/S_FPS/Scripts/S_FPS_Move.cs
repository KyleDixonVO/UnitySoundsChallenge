...
public class S_FPS_Move : MonoBehaviour
{
    ...
    public AudioSource CrouchWalk;
    public bool isCrouched;
    public bool isSprinting;
    static bool playSprint;
    static bool playWalk;
    static bool playCrouch;
    ...
    {
        if (characterController.isGrounded && currentInput.magnitude >= 0.1f)
        {
            playWalk = true;
        }
        else
        ...
        if (characterController.isGrounded && isSprinting && currentInput.magnitude >= 0.1)
        {
            playSprint = true;
        }
        else
        ...
        if (characterController.isGrounded && isCrouched && currentInput.magnitude >= 0.1)
        {
            playCrouch = true;
        }
        else
